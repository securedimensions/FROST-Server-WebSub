...
import de.fraunhofer.iosb.ilt.frostserver.json.serialize.*;
...
/**
 * Enables serialization of entities as JSON including empty array.
 *
 * @author andreasmatheus
 */
public class JsonWriterIncludeEmptyArray {
    ...
    private static ObjectMapper createObjectMapper() {
        ...
        // make sure that the empty arrays for `odata_denied` and `topics_denied` are serialized
    ...
    private JsonWriterIncludeEmptyArray() {
    }
